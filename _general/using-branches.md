...
{% include section.html level="h2" name="What is Branching?" %}
...
{% include section.html level="h2" name="When Should You Branch?" %}
...
{% include section.html level="h2" name="How Should You Branch?" %}
